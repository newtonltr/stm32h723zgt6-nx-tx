...
#endif
#if 0
    printf("nx_packet_prepend_ptr: %x %x %x %x\r\n",packet_ptr -> nx_packet_prepend_ptr[0],packet_ptr -> nx_packet_prepend_ptr[1],
    		packet_ptr -> nx_packet_prepend_ptr[2],packet_ptr -> nx_packet_prepend_ptr[3]);
#endif
